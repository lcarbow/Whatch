...
public class ImageHelperHorizontal implements Interfaces.apiPosterCallback{
    ...
    public ImageHelperHorizontal(int innerIndex, int outerIndex, Contract.ILandingViewGenre landingPageView) {
